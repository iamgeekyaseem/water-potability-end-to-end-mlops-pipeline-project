...
def experiment_tracking(metrics):
    try:
        ...
        with mlflow.start_run():
            ...
            train_df = mlflow.data.from_pandas(pd.read_csv("./data/processed/train_processed.csv"), "train_data")
            test_df = mlflow.data.from_pandas(pd.read_csv("./data/processed/test_processed.csv"), "test_data")
            ...
            sign = infer_signature(test_df.drop("Potability", axis=1), model.predict(test_df.drop("Potability", axis=1)))
