...
def experiment_tracking(metrics):
    try:
        ...
        with mlflow.start_run():
            ...
            train_df = from_pandas(pd.read_csv("./data/processed/train_processed.csv"), name="train_data")
            test_df = from_pandas(pd.read_csv("./data/processed/test_processed.csv"), name="test_data")
